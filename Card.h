...
public:
	...
	virtual void Save(ofstream &OutFile, ObjType obj)=0;    //Saves the GameObject parameters to the file
	virtual void Load(ifstream& Infile, Grid* pGrid)=0;   //Loads the GameObj parameters to the file						   
