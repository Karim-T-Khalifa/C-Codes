...
void CardEleven::SetOwner(Player* pPlayer)              //Sets all Stations with the same number to the player
{
	pOwner = pPlayer;
}
...
void CardEleven::Save(ofstream& OutFile, ObjType obj)  //Saves the GameObj parameters to the file
{
	if (obj == card)
	{
...
void CardEleven::Load(ifstream& Infile, Grid* pGrid)   //Loads the GameObj parameters to the file
{
	int cellNum;
